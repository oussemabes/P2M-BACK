const {displayProducts,createAuction,getCategories,displayByCategory, displayProduct,getCategory,countProducts,countProductsCategory}=require("../controllers/auctionController")
